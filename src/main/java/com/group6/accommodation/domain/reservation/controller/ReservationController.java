...
public class ReservationController {
    ...
    public ResponseEntity<ResponseApi<PagedDto<ReservationListItemDto>>> getList(
        @AuthenticationPrincipal CustomUserDetails user,
        @ModelAttribute ReservationRequestParamDto reqeustParam
    ) {
        PagedDto<ReservationListItemDto> responseData = reserveService.getList(user.getUserId(), reqeustParam);
        return ResponseEntity.ok(ResponseApi.success(HttpStatus.OK, responseData));
    }
}
